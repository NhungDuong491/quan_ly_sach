...
<section class="product-shop spad">
  ...
  <div class="container" style="margin-top:4em">
    <div>
      <h2 style="text-align: center">Tất cả </h2>
    </div>
    <div class="row">
          ...
          <div class="row">
            <ul class="nospace elements"
              ...
              <li data-id="{{$s->id}}" class="li" style="border: solid, 1em, black; padding-bottom:1em; margin-left:1em">
                ...
                <figure class="pi-pic"><img src="{{asset('upload/book/'.$s->image)}}" alt="" width="300px">
                    <h5 class="heading" style="width: 300px; text-align: center;" data-id="{{$s->id}}"><b>{{$s->name}}</b></h5>
                    <h5 class="heading" style="width: 300px; text-align: center;" data-id="{{$s->id}}">{{$s->price}},000 ₫</h5>
                  ...
                  <div id="myModal_{{$s->id}}" class="modal" style="margin-bottom: 2em">
                    <div class="modal-content" >
                      ...
                      <div style="display: flex">
                        ...
                        <div>
                          <h2><b>{{ $s->name }}</b></h2>
                          <h4>{{number_format($s->price)}},000 ₫</h4>
                  ...
                  <ul id="idd_{{$s->id}}">
                    ...
                    <li class="quick-view"><a onclick="AddCart({{$s->id}})" href="javascript:">Thêm vào giỏ hàng</a></li>
